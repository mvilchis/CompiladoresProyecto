...
public:
	...
	virtual void visit(WhileElseNode*) = 0;
	virtual void visit(ForElseNode*) = 0;
	...
	virtual void visit(HermanosNode*) = 0;
...
//	virtual Node * bBOOLNode () = 0;
	...
	virtual Node * bHERMANOSNode () = 0;
	virtual Node * bARGNode () = 0;
	virtual Node * bIFELSENode () = 0;
